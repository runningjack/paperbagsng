...
$page_nav["catalogue"]['sub']['option']['sub']['addnew']["active"] = false;
include("inc/nav.php");
                    ...
                    <div role="content" style="display: block;">
                        ...
                        <div class="widget-body">
                            ...
                            <div class="form-group">
                                <label class="col-md-2 control-label">Option Control</label>
                                <div class="col-md-10">
                                    <select class="form-control input" id="option_id" name="option_id">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-10">
                                    <input class="form-control" placeholder="New Option Title" id="title" name="title" type="text" required="required" value="" autocomplete="off">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-12 col-lg-12 text-right">
                                <a href="javascript:void(0);" id="addoption2" class="btn btn-labeled btn-primary"> <span class="btn-label"><i class="glyphicon glyphicon-plus"></i></span>Add New Option</a>
                                </div>
                            </div>
<hr>
                            <div  id="opt">
...
//function to format bites bit.ly/19yoIPO
        ...
        $("a#addoption2").on("click",function(){
            $("#opt").append('<div class="row mrow">'+
                '<div class="col-md-3 col-lg-3 col-3">'+
                '<p>Add Value Attribute here</p>'+
            '</div>'+
            '<div class="col-md-5 col-lg-5 col-5 sibdiv">'+
                '<div class="form-group">'+
                '<div class="col-md-12">'+
                '<input class="form-control optval" placeholder="New Option Title"  type="text" required="required" autocomplete="off">'+
                '</div>'+
            '</div>'+
            '</div>'+
            '<div class="col-md-2 col-lg-2 col-2 pdiv">'+
                '<div class="col-md-12 col-lg-12 text-right">'+
                '<a href="javascript:void(0)" class="btn btn-labeled btn-primary sv"> <span class="btn-label"><i class="glyphicon glyphicon-save"></i></span>Save</a>'+
            '</div>'+
            '</div>'+
            '<div class="col-md-2 col-lg-2 col-2">'+
                '<div class="col-md-12 col-lg-12 text-right">'+
                '<a  href="javascript:void(0)" class="btn btn-labeled btn-danger rmv"> <span class="btn-label"><i class="glyphicon glyphicon-minus"></i></span>Remove</a>'+
            '</div>'+
            '</div>'+
            '</div>')
        })

        $("#opt").on("click",".rmv",function(){
            var c = $(this).parents('div.mrow')
            c.remove();
        })

        $("#opt").on("click",".sv",function(){
            $(this).each(function(){
                var p = $(this).parents("div.pdiv").siblings("div.sibdiv")
                var s = p.children("div.form-group").children("div.col-md-12").children("input.optval")
                console.log(s.val())
                var request =  $.ajax({
                    url:"",
                    type:"post",
                    data:{optionid:$("#option_id").val(),title:$("#title").val(),optvalue: s.val(),action:"saveoption"},
                    dataType:"html"
                })
