...
$page_nav["frontend"]["sub"]["pageblock"]["active"] = true;
include("inc/nav.php");
...
?>
    ...
    <div class="row">
        <div class="col-xs-12 col-sm-7 col-md-7 col-lg-4">
            <h1 class="page-title txt-color-blueDark"><i class="fa-fw fa fa-code"></i> Pageblock<span>> Edit- {{$mypage->title}} </span></h1>
