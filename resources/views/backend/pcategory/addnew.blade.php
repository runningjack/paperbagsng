...
?>
    ...
    <div id="main" role="main" xmlns="http://www.w3.org/1999/html">
        ...
        <div id="content">
            ...
            {{Form::open(array('action'=>array('Backend\CatalogueController@postCategoryAddNew', ""), 'method'=>'POST', 'class'=>'form-horizontal', 'files'=>true)) }}
            <div class="row">
                <div class="col-sm-9">
...
<a  class="inline2" href="#inline_content2" id="dd">Browse</a>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                           <label class="checkbox-inline">
                                                <input id="top" name="top" value="1" class="checkbox style-0" type="checkbox">
