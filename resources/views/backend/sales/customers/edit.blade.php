...
?>
    ...
    {{Form::open(array('action'=>array('Backend\SalesController@postCustomerAdd', "$customer->id"), 'method'=>'POST', 'class'=>'form-horizontal', 'files'=>true)) }}
    <div class="row">
    <div class="col-md-9">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active" id="tab-r1">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-10 col-10">
                                        <input class="form-control" placeholder="Enter first name" id="firstname" name="firstname" type="text" required="required" value="{{$customer->firstname}}" autocomplete="off">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-10">
                                        <input class="form-control" placeholder="Enter last name" id="firstname" name="lastname" type="text" required="required" value="{{$customer->lastname}}" autocomplete="off">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-10">
                                        <input class="form-control" placeholder="Enter email" id="email" name="email" type="email" required="required" value="{{$customer->email}}" autocomplete="off">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-10">
                                        <input class="form-control" placeholder="Enter phone number" id="phone" name="phone" type="text" required="required" value="{{$customer->phone}}" autocomplete="off">
                                    </div>
                                </div>
                            ...
                            <div class="tab-pane" id="tab-r2">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-10">
                                        <input class="form-control" placeholder="Enter Company" id="company" name="company" type="text"  value="{{$customer->company}}" autocomplete="off">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-10">
                                        <input class="form-control" placeholder="Enter contact person" id="contact" name="contact" type="text"  value="{{$customer->contact}}" autocomplete="off">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <label class="col-md-2 control-label">Apartment</label>
                                    <div class="col-md-10">
                                        <input class="form-control" placeholder="Enter contact Block/Floor/Room No etc" id="apartment" name="apartment" type="text" value="{{$customer->apartment}}" autocomplete="off">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-10">
                                        <input class="form-control" placeholder="Enter city" id="confirm" name="city" type="text" required="required" value="{{$customer->city}}" autocomplete="off">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-10">
                                        <input class="form-control" type="text" id="state" name="state" placeholder ="State / Country" required value="{{$customer->state}}">
                                    </div>
                                </div>
