...
?>
    ...
    {{Form::open(array('action'=>array('Backend\CatalogueController@postProductAddNew', $myproduct->id), 'method'=>'POST', 'class'=>'form-horizontal', 'files'=>true)) }}
    <div class="row">
    <div class="col-sm-9">
                    ...
                    <div id="myTabContent1" class="tab-content padding-10">
                        <div class="tab-pane fade in active" id="s1">
                            <div class="form-group">
                                ...
                                <div class="col-md-10">
                                    <input class="form-control" placeholder="New Category Title" id="title" name="title" type="text" required="required" value="{{$myproduct->title}}" autocomplete="off">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-2 control-label">Description</label>
                                <div class="col-md-10">
                                    <textarea id="description" name="description" class="form-control">{{$myproduct->description}}</textarea>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-2 control-label">Meta Title</label>
                                <div class="col-md-10">
                                    <textarea id="meta_title" name="meta_title" class="form-control" placeholder="Title" rows="4">{{$myproduct->meta_title}}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-10">
                                    <textarea id="meta_keyword" name="meta_keyword" class="form-control" placeholder="Keyword" rows="4">{{$myproduct->meta_keyword}}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-10">
                                    <textarea class="form-control" placeholder="Description" rows="4" name="meta_description" id="meta_description">{{$myproduct->meta_description}}</textarea>
                                </div>
                            </div>
                        </div>
                        <div class="tab-pane fade" id="s2">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    <input class="form-control" placeholder="model" id="model" name="model" type="text" value="{{$myproduct->model}}" autocomplete="off">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    <input class="form-control" placeholder="Satock keeping unit" id="suk" name="suk" type="text" value="{{$myproduct->suk}}" autocomplete="off">

                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-4 control-label">Price<small></small></label>
                                <div class="col-md-8">
                                    <input class="form-control" placeholder="price" id="price" name="price" type="text" value="{{$myproduct->price}}" autocomplete="off">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    <input class="form-control" placeholder="" id="quantity" name="quantity" type="text" value="{{$myproduct->quantity}}" autocomplete="off">
                            ...
                            <div class="form-group">
                                <label class="col-md-4 control-label">MO <small>Minimum order level, force reorder when stock is low</small></label>
                                <div class="col-md-8">
                                    <input class="form-control" placeholder="" id="minimum" name="minimum" type="text" value="{{$myproduct->minimum}}" autocomplete="off">
                                </div>
                            </div>
                        </div>
                        <div class="tab-pane fade" id="s3">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-10">
                                    <textarea id="cat" name="cat" rows="4" class="form-control"><?php
                                        $cats = \DB::table("categories_products")->where("product_id",$myproduct->id)->get();
                                        $catnames ="";
                                        foreach($cats as $cat){
                                            if(\Product::find($cat->product_id) ){
                                                $catnames .= \DB::table("categories")->where("id",$cat->category_id)->pluck("title");
                                                $catnames .=",";
                                            }
                                        }
                            ...
                            <div class="form-group">
                                <label class="col-md-2 control-label">Product Brand</label>
                                <div class="col-md-10">
                                    <select class="form-control" id="brand_id" name="brand_id">
                                        <option value="">--SELECT PRODUCT BRAND--</option>
                                        @foreach($brands as $brand)
                                        @if($brand->id == $myproduct->brand_id)
                        ...
                        <div class="tab-pane fade" id="s4">
                            <div class="tabs-left">
                                <ul class="nav nav-tabs tabs-left" id="demo-pill-nav">
                                    @if($myoptionvalues)
                                    {{--*/$x=0/*--}}
                                    @foreach($myoptionvalues as $poption)
                                    {{--*/ $opttable = \Optionvalue::find($poption->option_value_id)/*--}}
                                    <li
                                    @if($x==0)
                                    {{"class='mq active'"}}
                                    @endif
                                    {{--*/$title = $opttable->title/*--}}
                                    ><a href="#tab-r{{$x}}" data-toggle="tab">{{$opttable->title}}</a></li>
                                    {{--*/$x++/*--}}
                                    @endforeach
                                    @endif
                                ...
                                <div class="tab-content" id="option-tab-content">
                                    ...
                                    @endif
                                    " id="tab-r{{$x}}">
                                        {{--*/ $productoptions = \DB::table("options_values")->where("title",$poption->option_type)->get()/*--}}
                                        <div class="row"><div class="col-sm-10 col-lg-10 col-10 ">
                                                <table class="table table-bordered table-condensed" id="option-value{{$x}}"><thead><tr><th>Option Value</th><th>Quantity</th><th>Subtract Stock</th>
                                                        <th>Price</th><th>Points</th><th>weight</th><th></th></tr></thead>
                                                    <?php $rows=0; ?>
                                                    @foreach($productoptions as $productoption)
                                                    {{--*/$optionRow = \Productoptions::where("product_option_value_id","=",$poption->product_option_value_id)->first()/*--}}
                                                    {{--*/$optionRow = \Productoptions::where("option_value_id",$productoption->id)->first()/*--}}
                                                    <tbody id="option-value-row{{$rows}}">
                                                    <tr>

                                                        <td class="left"><select name="product_option[{{$x}}][product_option_value][{{$rows}}][option_value_id]">
                                                                {{--*/ $productrowoptions = \DB::table("options_values")->where("title","=",$poption->option_type)->get()/*--}}

                                                                @foreach($productrowoptions as $productrowsoption)
                                                                <option value="{{$productrowsoption->id}}"  @if($productrowsoption->id == $optionRow->option_value_id ) {{"selected"}} @endif >{{$productrowsoption->optvalue}}</option>
                                                                @endforeach

                                                            </select><input type="hidden" name="product_option[{{$x}}][product_option_value][{{$rows}}][option_type]" value="{{$optionRow->option_type}}" /><input type="hidden" name="product_option[{{$x}}][product_option_value][{{$rows}}][product_option_value_id]" value="{{$optionRow->product_option_value_id}}" /></td>
                                                        <td class="right"><input type="text" name="product_option[{{$x}}][product_option_value][{{$rows}}][quantity]" value="{{$optionRow->quantity}}" size="3" /></td>
                                                        <td class="left"><select name="product_option[{{$x}}][product_option_value][{{$rows}}][subtract]">
                                                                <option value="1">Yes</option>
                                                                <option value="0">No</option>
                                                            </select></td>
                                                        <td class="right"><select style="display:inline" name="product_option[{{$x}}][product_option_value][{{$rows}}][price_prefix]">
                                                                <option value="+">+</option>
                                                                <option value="-">-</option>
                                                            </select>
                                                            <input type="text" name="product_option[{{$x}}][product_option_value][{{$rows}}][price]" value="{{$optionRow->price}}" size="5" /></td>
                                                        <td class="right"><select name="product_option[{{$x}}][product_option_value][{{$rows}}][points_prefix]">
                                                                <option value="+">+</option>
                                                                <option value="-">-</option>
                                                            </select>
                                                            <input type="text" style="display:inline" name="product_option[{{$x}}][product_option_value][{{$rows}}][points]" value="{{$optionRow->points}}" size="5" /></td>
                                                        <td class="right"><select style="display:inline !important;" name="product_option[{{$x}}][product_option_value][{{$rows}}][weight_prefix]">
                                                                <option value="+">+</option>
                                                                <option value="-">-</option>
                                                            </select>
                                                            <input type="text" style="display:inline !important;" name="product_option[{{$x}}][product_option_value][{{$rows}}][weight]" value="{{$optionRow->weight}}" size="5" /></td>
                                                        <td class="left"><a class="btn btn-danger" onclick="$('#option-value-row{{$rows}}').remove();" class="button">Remove</a></td>
                                                    </tr>
                                                    </tbody>
                                                    {{--*/ $rows++/*--}}
                                                    @endforeach
                                                    ...
                                                    <tfoot><tr><td colspan="7"><a  onclick="addOptionValue('{{$x}}','{{$opttable->title}}');" class="btn btn-primary" data="{{$opttable->title}}">Add Option Value</td></tr></tfoot></table>
                                            </div></div>
                        ...
                        <div class="form-group">
                            <div class="col-md-12">
                                <label class="checkbox-inline">
                                    ...
                                    @if($myproduct->view_status == "visible")
                                    checked
                                    @endif

                                    >
                                    <span>View Status</span><span class=""><small><i> Check to indicate whether product is active and unchecked if you want to deactivate product</i></small>s</span>
                                </label>
                            </div>
                        </div>
                        <div class="form-group">
...
//function to format bites bit.ly/19yoIPO
    ...
    <script type="text/javascript">
        ...
        function addOptionValue(option_row,option_type) {
            option_value_row = $('#option-value' + option_row + ' tfoot').siblings("tbody").size()
