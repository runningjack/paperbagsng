...
<?php
    ...
    $page_nav["catalogue"]['sub']['brand']['sub']['list']["active"] = false;
    include("inc/nav.php");
    $breadcrumbs["Product brands"] =""
    ?>
    <style type="text/css">
                            ...
                            <div>
                                ...
                                <div class="widget-body no-padding">
                                    ...
                                    <div class="text-right">
                                        {{HTML::decode(HTML::linkRoute('brandadd','<span class="btn-label"><i class="glyphicon glyphicon-plus"></i></span> Add New',null,array("class"=>"btn btn-labeled btn-primary")))}}
                                    </div>
                                    <table id="datatable_fixed_column" class="table table-striped table-bordered" width="100%">
                                        ...
                                        <tr>
                                            ...
                                            <td>{{HTML::linkRoute('brandedit',"Edit",$category->id)}}</td>
                                        </tr>
                                        {{--*/$x++/*--}}
                                        @endforeach
                                        @else
