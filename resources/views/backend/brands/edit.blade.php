...
?>
    ...
    <div id="main" role="main" xmlns="http://www.w3.org/1999/html">
        ...
        <div id="content">
            ...
            {{Form::open(array('action'=>array('Backend\CatalogueController@postBrandAddNew', $mybrand->id), 'method'=>'POST', 'class'=>'form-horizontal', 'files'=>true)) }}
            <div class="row">
                <div class="col-sm-9">
                        ...
                        <div role="content" style="display: block;">
                            ...
                            <div class="widget-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-10">
                                        <input class="form-control" placeholder="Brand Code/ Short Name" id="code" name="code" type="text"  value="{{$mybrand->code}}" autocomplete="off">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-10">
                                        <input class="form-control" placeholder="New Category Title" id="title" name="title" type="text" required="required" value="{{$mybrand->title}}" autocomplete="off">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-2 control-label">Description</label>
                                    <div class="col-md-10">
                                        <textarea id="description" name="description">{{$mybrand->description}}</textarea>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-12" style="margin: 0; padding: 0">
                                            <div id="imgg" style="background-color: #c3c3c3; padding: 10px; text-align: center">
                                                @if($mybrand->image !="")
                                                <img src="{{ \Croppa::url(ASSETS_URL.'/uploads/images/'.$mybrand->image, 100, 100)}}" >
                                                @else
                                                <i class="fa fa-camera fa-5x"></i>
                                                @endif
                                            </div>
                                            <a  class="inline2" href="#inline_content2" id="dd">Browse</a>
                                            <input type="hidden" id="image" name="image" value="{{$mybrand->image}}">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="col-md-12">
                                            <label class="checkbox-inline">
                                                <input id="view_status" name="view_status"
                                                @if($mybrand->view_status == "hidden")
