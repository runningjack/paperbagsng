                        ...
                        <div role="content" class="">
                            ...
                            <div class="widget-body">
                                ...
                                <div class="col-md-12" style="margin: 0; padding: 0">
                                    ...
                                    <input type="hidden" id="image" name="image" value="{{\Illuminate\Support\Facades\Input::old('image')}}">
                                ...
                                <div class="col-12 col-md-12 col-lg-12">
                                    <div class="form-group">
                                        <input class="form-control" id="video" name="video" placeholder="https://vimeo.com/78468485" type="text" value="{{\Illuminate\Support\Facades\Input::old('video')}}">
                                    </div>
                                </div>
                                ...
                                <div class="col-12 col-md-12 col-lg-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div >
                                            ...
                                            <input type="hidden" id="olddocument" name="olddocument" value="{{\Illuminate\Support\Facades\Input::old('document')}}"
                                            <p class="help-block">
