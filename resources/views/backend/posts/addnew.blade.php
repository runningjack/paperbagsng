                                ...
                                <span class="button">
                                    ...
                                    <div class="row smart-form">
                                        <fieldset><legend>Video</legend>
                                            ...
                                            <label class="input input-file">
                                                <input class=""  type="text" placeholder="http://www.youtube.com/watch?v=UCOC1YwNwZw" name="video" id="video" >
                                            </label>
                                        </fieldset>
                                    </div>
                                    </p>
            ...
            <div class="col-sm-3">
                        ...
                        <div class="widget-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6" >
                                    ...
                                    <div id="edit-file-uploader"><div class="qq-uploader-selector qq-uploader">
                                            ...
                                            <div class="qq-upload-button-selector qq-upload-button" style="position: relative; overflow: hidden; direction: ltr;">
                                                ...
                                                <input qq-button-id="0951a5ec-8c08-4a39-b2ef-ec719bfbfb2b" multiple="" type="file" name="qqfile" style="position: absolute; right: 0px; top: 0px; font-family: Arial; font-size: 118px; margin: 0px; padding: 0px; cursor: pointer; opacity: 0; height: 100%;"></div>
                <span class="qq-drop-processing-selector qq-drop-processing qq-hide">
                    ...
                    <span class="qq-drop-processing-spinner-selector qq-drop-processing-spinner"></span>
                                    ...
                                    <div id="edit-file-upload-trigger" class="btn btn-primary" style="margin-top: 10px;">
                ...
                <div class="jarviswidget jarviswidget-sortable" id="wid-id-13" data-widget-load="ajax/demowidget.php" data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-togglebutton="false" data-widget-deletebutton="false" data-widget-fullscreenbutton="false" data-widget-custombutton="false" role="widget">
                    ...
                    <div role="content" class="">
                        ...
                        <div class="widget-body">
                            ...
                            <div class="radio">
                                <label>
                                    <input type="radio" class="radiobox style-0 rd" id="parent_id" name="parent_id" data="{{$category->title}}" value="{{$category->id}}">
                                    <span>{{$category->title}}</span>
                                </label>
                            </div>
                            <!--<div class="form-group">
                                <div class="col-md-6" style="margin: 0; padding: 0">
                                    <label class="radio rd">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 ">
                                    <div class="form-group">
                                        <input class="form-control" placeholder="Stock price date from" type="text" name="start_date" value="" id="from">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 hidden-mobile">
                                    <div class="form-group ">
                                        <input class="form-control" placeholder="Stock price date to" type="text" name="end_date" value="" id="to">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 ">
                                    <div class="form-group">
                                        <input class="form-control" placeholder="Stock price date from" type="text" name="start_time" value="" id="timefrom">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 hidden-mobile">
                                    <div class="form-group ">
                                        <input class="form-control" placeholder="Stock price date to" type="text" name="end_time" value="" id="timeto">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row smart-form">
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        <textarea rows="2" id="venue" name="venue" class="form-control"></textarea>
                                </div>
                            </div>
                            </div>
                        </div>
...
<script src="<?php echo ASSETS_URL; ?>/js/all.fine-uploader-5.1.3.min.js"></script>
    ...
    <script>
        ...
        $(document).ready(function() {
           ...
           var perma =""
            ...
            $(".inlineevent").colorbox({inline:true, width:"20%",height:"20%"})
...
<script>
    $(function () {
        ...
        var url = window.location.hostname === 'blueimp.github.io' ?
                '//jquery-file-upload.appspot.com/' : 'addnew',
            uploadButton = $('<button/>')
